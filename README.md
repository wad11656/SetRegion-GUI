...
- **Memory Card Utility** doesn't work (for me) on Vita-Adrenaline, so you can't manage the saves for the individual games from there. As a workaround, you can force the Vita to create separate **Save Data Utility** entries for each game (while still using the same **Game ID**).
