...
2. **[LibCrypt Patch](https://archive.org/details/lib-crypt-ppf-patches) (PAL only)** - Use [PPF-O-Matic](https://www.romhacking.net/utilities/356/) to apply your game's PPF patch to patch out any game-breaking protection mechanisms.
