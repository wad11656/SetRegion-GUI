...
## EBOOT Tips:
 ...
 - Even though the Vita emulates a form of PSP FW 6.61, the PS1 emulator is slightly different, particularly the CDDA audio mechanism (applies only to multi-track/multi-`.bin` PS1 game EBOOTs). Therefore, some in-game audio tracks that make the PSP crash on FW 6.61 do _not_ make Vita-Adrenaline crash.
